  ...
  return (
    <div className="container m-auto">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {/*--------services------card------1------*/}
        <div className="border-2 relative flex flex-col text-gray-700 bg-white rounded-md">
          <div className="p-8 text-center">
            ...
            <p className="md:text-xl lg:text-xl text-slate-800">
              Because its about motivating the doers. Because Im here to follow
        ...
        <div className="border-2 relative flex flex-col text-gray-700 bg-white rounded-md">
          <div className="p-8 text-center">
            <i className="fa-solid fa-people-line flex items-center justify-center text-3xl bg-[#008080] p-3 rounded-full text-white w-[60px] h-[60px] m-auto mb-2"></i>
            <h5 className="py-2 text-xl md:text-2xl lg:text-2xl font-bold text-black">
        ...
        <div className="border-2 relative flex flex-col text-gray-700 bg-white rounded-md">
          <div className="p-8 text-center">
            <i className="fa-solid fa-person-dress flex items-center justify-center text-3xl bg-[#008080]  p-3 rounded-full text-white w-[60px] h-[60px] m-auto mb-2"></i>
            <h5 className="py-2 text-xl md:text-2xl lg:text-2xl font-bold text-black">
              Tour Gider
            </h5>
            <p className="md:text-xl lg:text-xl text-slate-800">
        ...
        <div className="border-2 relative flex flex-col text-gray-700 bg-white rounded-md">
          <div className="p-8 text-center">
            <i className="fa-solid fa-bath flex items-center justify-center text-3xl bg-[#008080] p-3 rounded-full text-white w-[60px] h-[60px] m-auto mb-2"></i>
            <h5 className="py-2 text-xl md:text-2xl lg:text-2xl font-bold text-black">
