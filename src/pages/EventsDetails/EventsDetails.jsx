                ...
                <div>
                  ...
                  <div className="py-5">
                    <p className="text-xl text-slate-700 text-justify">
                      A cocktail party is a social occasion, usualy held in
                      early evening. Coocktails, other alcoholic drinks are
                      served alongside a selection of night nibbles, called
                      conopes. The dress code is quite dressy, and a cocktail
                      party will typically last for two to three house.
                    </p>
                    <p className="text-xl text-slate-700 text-justify mt-4">
                      These parties are social events where guests are
                      encouraged to sociallizo with ono other, mingle and
                      converse.
                    </p>
                  </div>
                  <Link to="/">
            ...
            <div className="flex gap-16 flex-col-reverse lg:flex-row py-20">
              ...
              <div className="flex-1">
                <div>
                  ...
                  <div className="py-5">
                    <p className="text-xl text-slate-700 text-justify">
                      Brunch, that delightfil mid-morning fusion of breakfast
                      and lunch, embodies the essence of leisurely enjoyment. It
                      is an invitng accasion to gather friends, share stories
                      and savar a mediey of flavors.
                    </p>
                    <p className="text-xl text-slate-700 text-justify mt-4">
                ...
                <div>
                  ...
                  <div className="py-5">
                    <p className="text-xl text-slate-700 text-justify">
                      ...
                      arrangements, and complimentary high-speed Wi-Fi, our
                      spaces are ideal for business meetings, seminars, and
