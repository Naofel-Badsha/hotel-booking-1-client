    ...
    <div>
      ...
      <ul>
        <li className="relative">
          <img
            src="https://i.ibb.co.com/dkYNvPr/AbDt-4.jpg"
            style={{
              width: "100%",
              height: "91vh",
              marginTop: "100px",
      ...
      <div className="container m-auto py-5">
        <div className="px-3">
          ...
          {/*-----------About-------Creative------Team------*/}
          <div className="py-20">
            <h2 className="text-2xl md:text-3xl lg:text-3xl text-center font-bold text-black mb-16">
              Our Creative Team
            </h2>
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="border-2 border-[#008080] py-8 px-5 shadow-xl rounded-lg hover:-translate-y-2 duration-100">
                <img
                  src="https://i.ibb.co.com/QYBn1CV/test-1.jpg"
                  className="w-40 h-40 object-cover rounded-full m-auto"
                />
                <h3 className="text-xl md:text-2xl lg:text-2xl font-bold mt-4 text-center text-black">
                  James Smits
                </h3>
                <h4 className="text-xl font-bold text-center text-[#008080] py-2">
                  Administrator
                </h4>
                <p className="text-xl text-slate-700">
                  Bringing forth the ability to handle a variety of clerical and
                  Administrative tasks to ensure smooth hotel corperation{" "}
                </p>
              </div>
              {/*-----------Mermber-----2-------*/}
              <div className="border-2 border-[#008080] py-8 px-5 shadow-xl rounded-lg hover:-translate-y-2 duration-100">
                <img
                  src="https://i.ibb.co.com/5vv4w07/istockphoto-1464618883-612x612.jpg"
                  className="w-40 h-40 object-cover rounded-full m-auto"
                />
                <h3 className="text-xl md:text-2xl lg:text-2xl font-bold mt-4 text-center text-black">
                  Mical Cleark
                ...
                <p className="text-xl text-slate-700">
                  Experiences Hotel Manager with a proven track record in
                  delivering exceptional customer services amd achieving
              ...
              <div className="border-2 border-[#008080] py-8 px-5 shadow-xl rounded-lg hover:-translate-y-2 duration-100">
                <img
                  src="https://i.ibb.co.com/ZKgh9Wc/test-7.jpg"
                  className="w-40 h-40 object-cover rounded-full m-auto"
                />
                <h3 className="text-xl md:text-2xl lg:text-2xl font-bold mt-4 text-center text-black">
                  Aston Agar
                ...
                <p className="text-xl text-slate-700">
                  proficient in picking up new procedures and task quickly while
                  elevating customer services standards in ever role.
                </p>
              </div>
            </div>
          </div>
